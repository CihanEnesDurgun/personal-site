...
class BlogManager {
  ...
  updateCommentsCount() {
    // Güvenli kontrol - comments undefined olabilir
    const comments = this.comments || [];
    // Sadece onay bekleyen yorumları say (approved: false olanlar)
      ...
      if (statisticsContainer) {
        statisticsContainer.innerHTML = `
          <div class="stat-card">
            ...
            <div class="stat-label">Log Dosyası</div>
          </div>
          <div class="stat-card">
...
function resetImageUploadModal() {
  ...
  if (insertButtonText) {
    if (currentImageUploadContext === 'avatar') {
      insertButtonText.textContent = 'Avatar Olarak Seç';
    } else {
...
function showGallerySelection() {
  ...
  if (uploadContent) {
    uploadContent.innerHTML = `
      ...
      <h4>Galeriden Resim Seç</h4>
      <p>Mevcut galeriden bir resim seçin</p>
    ...
    if (currentImageUploadContext === 'avatar' && galleryManager) {
      ...
      notification.innerHTML = `
        <div class="notification-content">
          ...
          <span class="notification-text">Avatar olarak kullanmak istediğiniz resme tıklayın</span>
...
function showAvatarSelectionSuccess() {
  ...
  notification.innerHTML = `
    <div class="notification-content">
      <span class="notification-icon">✅</span>
      <span class="notification-text">Avatar başarıyla seçildi!</span>
      <button class="notification-close" onclick="this.parentElement.parentElement.remove()">×</button>
    </div>
  `;
