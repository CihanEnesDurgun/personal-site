...
Markdown, 2004 yılında[^1] John Gruber tarafından[^2] geliştirilen, basit ve okunabilir bir işaretleme dilidir. Temel amacı, yazarların içeriklerini *doğal bir şekilde* yazabilmelerini sağlamaktır. HTML'in karmaşıklığından uzak, sadece metin dosyalarında bile mükemmel görünen bir format sunar.
...
**Gelecek Güvencesi:** Basit metin formatı sayesinde[^3] 50 yıl sonra bile okunabilir
...
- **Başlıklar:** H1, H2, H3 butonları ile hiyerarşik[^4] yapı oluşturun
...
[^1]: bkz: alanaşgknşanegnaekşngşkeanşkangşna *aaaa*
[^2]: aaaaaaaaaaaa
[^3]: aaaa
[^4]: abc3